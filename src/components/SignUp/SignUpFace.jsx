...
class SignUpFace extends Component {
    constructor(props){
        super(props);
        this.state = {
            email: '',
  ...
  logado(){
    if(!!firebase.auth().currentUser){
      ...
      this.state.nome = firebase.auth().currentUser.displayName
    }
    else{
    ...
    return(
      <React.Fragment>
        ...
        <form className="form">
          ...
          <button type="submit" onClick= { ()=> this.cadastrarBD()} className="btn btn-primary btn-block mt-1">Cadastrar</button>
        </form>
      </React.Fragment>
    )
  }
